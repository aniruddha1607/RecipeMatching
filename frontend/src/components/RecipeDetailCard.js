...
const RecipeDetailCard = ({ recipe }) => {
  return (
    ...
    <img className="object-cover w-full rounded-lg h-96 md:h-auto md:w-60 md:rounded-lg m-5" src={recipe.image} alt={recipe.label} /> 
    <div className="flex flex-col justify-between p-4 leading-normal">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{recipe.label}</h5>
